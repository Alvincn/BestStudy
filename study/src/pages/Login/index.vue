  ...
  <div id="login">
    ...
    <transition name="el-fade-in-linear">
      <div id="form" v-show="isLogin">
        <h1 style="text-align: center;font-size: 30px;color: white">用户登录</h1>
    ...
    <!-- 这是注册状态 -->
    <transition name="el-fade-in-linear">
      <div id="form1" v-show="isRegister"><h1 style="text-align: center;font-size: 30px;color: white">用户注册</h1>
    ...
    login() {
      ...
      this.$api.post('/login', this.userLogin).then(res => {
        if (res.code === 200) {
          ...
          window.localStorage.setItem('username', this.userLogin.phone)
          this.$router.push('/home')
